...
Class.xHunterTurret = makeTurret('xHunter', {canRepel: true, limitFov: true, extraStats: []})
Class.minigunTurret = makeTurret('minigun', {aiSettings: {SKYNET: true, FULL_VIEW: true, independent: true, extraStats: []}})
